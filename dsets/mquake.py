...
class MQuAKEPromptCompletionDataset(Dataset):
    def __init__(self, data_file='/data/jay/knowledge-editing/dsets/MQuAKE-CF-3k-v2.json', type = 'cloze', max_examples=10_000):
        """
...
if __name__ == "__main__":
    dataset = MQuAKEPromptCompletionDataset(data_file='MQuAKE-CF-3k-v2.json', type = 'qna', max_examples=30_000)
